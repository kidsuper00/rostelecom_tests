...
class AuthPage(BasePage):
    ...
    def enter_number(self, value):
        number = self.driver.find_element(*AuthLocators.AUTH_NUMBER)
    ...
    def logo_click(self):
        logo_click = self.driver.find_element(*AuthLocators.AUTH_LOGO)
        logo_click()
...
class AuthRegistration(AuthPage):
    ...
    def open_registration_page(self):
        btn_click = self.driver.find_element(*AuthLocators.AUTH_REGISTRATION)
        btn_click()
        time.sleep(5)
